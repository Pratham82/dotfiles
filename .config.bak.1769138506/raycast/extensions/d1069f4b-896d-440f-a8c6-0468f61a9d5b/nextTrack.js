"use strict";var d=Object.create;var a=Object.defineProperty;var w=Object.getOwnPropertyDescriptor;var g=Object.getOwnPropertyNames;var k=Object.getPrototypeOf,x=Object.prototype.hasOwnProperty;var h=(t,e)=>{for(var r in e)a(t,r,{get:e[r],enumerable:!0})},u=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of g(e))!x.call(t,o)&&o!==r&&a(t,o,{get:()=>e[o],enumerable:!(n=w(e,o))||n.enumerable});return t};var A=(t,e,r)=>(r=t!=null?d(k(t)):{},u(e||!t||!t.__esModule?a(r,"default",{value:t,enumerable:!0}):r,t)),T=t=>u(a({},"__esModule",{value:!0}),t);var I={};h(I,{default:()=>E});module.exports=T(I);var i=require("@raycast/api");var l=A(require("node:process"),1),f=require("node:util"),s=require("node:child_process"),N=(0,f.promisify)(s.execFile);async function p(t,{humanReadableOutput:e=!0}={}){if(l.default.platform!=="darwin")throw new Error("macOS only");let r=e?[]:["-ss"],{stdout:n}=await N("osascript",["-e",t,r]);return n.trim()}function m(t){return`
    tell application "Spotify"
      ...
      if playerState is "playing" then
        return currentTrackName & " by " & currentTrackArtist
          ...
          return "Not playing"
      end if`;try{let e=await p(t);await(0,c.showHUD)("\u{1F3A7} "+e)}catch(e){console.error(e)}}var E=async()=>{let t=m("next track");await y(t),await S()};
