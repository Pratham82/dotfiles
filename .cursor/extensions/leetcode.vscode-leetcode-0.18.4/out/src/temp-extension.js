...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            context.subscriptions.push(leetCodeStatusBarController_1.leetCodeStatusBarController, leetCodeChannel_1.leetCodeChannel, leetCodePreviewProvider_1.leetCodePreviewProvider, leetCodeSubmissionProvider_1.leetCodeSubmissionProvider, leetCodeSolutionProvider_1.leetCodeSolutionProvider, leetCodeExecutor_1.leetCodeExecutor, markdownEngine_1.markdownEngine, CodeLensController_1.codeLensController, explorerNodeManager_1.explorerNodeManager, vscode.window.registerFileDecorationProvider(LeetCodeTreeItemDecorationProvider_1.leetCodeTreeItemDecorationProvider), vscode.window.createTreeView("leetCodeExplorer", {
                treeDataProvider: LeetCodeTreeDataProvider_1.leetCodeTreeDataProvider,
                showCollapseAll: true,
            }), vscode.commands.registerCommand("leetcode.deleteCache", () => cache.deleteCache()), vscode.commands.registerCommand("leetcode.toggleLeetCodeCn", () => plugin.switchEndpoint()), vscode.commands.registerCommand("leetcode.signin", () => leetCodeManager_1.leetCodeManager.signIn()), vscode.commands.registerCommand("leetcode.signout", () => leetCodeManager_1.leetCodeManager.signOut()), vscode.commands.registerCommand("leetcode.manageSessions", () => session.manageSessions()), vscode.commands.registerCommand("leetcode.previewProblem", (node) => {
...
//# sourceMappingURL=temp-extension.js.map