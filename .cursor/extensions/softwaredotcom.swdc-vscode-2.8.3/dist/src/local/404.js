...
exports.getConnectionErrorHtml = void 0;
const Util_1 = require("../Util");
async function getConnectionErrorHtml() {
    const dancePartyImg = `vscode-resource:${(0, Util_1.getImage)('404-image.png')}`;
    return `<!DOCTYPE html>
      <html lang="en">
      <head>
          <meta charset="UTF-8">
...
exports.getConnectionErrorHtml = getConnectionErrorHtml;
