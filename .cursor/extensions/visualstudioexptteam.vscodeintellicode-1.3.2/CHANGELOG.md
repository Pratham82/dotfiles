# Change Log
## [1.3.2]
- Update health and metrics dependencies

## [1.3.1]
- Fix timing issue when activating TypeScript/JavaScript plugin (fixes [#545](https://github.com/MicrosoftDocs/intellicode/issues/545))
