...
exports.webviewContentFactory = void 0;
...
`;
function webviewContentFactory(context, currentPanel, fileCache, filePattern) {
    return () => {
        var _a;
        const ignoredDirectories = (_a = vscode.workspace
            .getConfiguration('lintel')) === null || _a === void 0 ? void 0 : _a.get('ignoredDirectories', ['node_modules', 'build', 'dist', 'out']);
        vscode.workspace
            .findFiles(filePattern, `**/{${ignoredDirectories.join(',')}}/**`)
            .then((uris) => {
            // read all the ESLint files
            const eslintFiles = uris.reduce((acc, uri) => {
            ...
            const delta = Object.keys(fileCache).length !== Object.keys(eslintFiles).length ||
...
exports.webviewContentFactory = webviewContentFactory;
