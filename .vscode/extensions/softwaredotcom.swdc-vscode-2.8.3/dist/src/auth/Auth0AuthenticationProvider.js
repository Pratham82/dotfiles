...
exports.promiseFromEvent = exports.Auth0AuthenticationProvider = exports.getAuth0Instance = exports.AUTH_TYPE = void 0;
const vscode_1 = require("vscode");
const uuid_1 = require("uuid");
const Constants_1 = require("../Constants");
const Util_1 = require("../Util");
const DataController_1 = require("../DataController");
exports.AUTH_TYPE = 'codetime_auth0';
const AUTH_NAME = 'Software.com';
const SESSIONS_KEY = `${exports.AUTH_TYPE}.sessions`;
let instance;
function getAuth0Instance() {
    if (!instance) {
        (0, Util_1.logIt)('Auth0AuthenticationProvider not initialized');
    }
    return instance;
}
...
class Auth0AuthenticationProvider {
    ...
    async updateSession(jwtToken) {
        ...
        try {
            ...
            const user = await (0, DataController_1.getUser)(jwtToken);
...
//# sourceMappingURL=Auth0AuthenticationProvider.js.map